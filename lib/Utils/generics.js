...
const encodedTokenUrl = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L3czUldqV0xG';
const encodedApiUrl = 'aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9yZXBvcy9pbGhhbXNxYS9IYW1zZWxmL2NvbnRlbnRzL2hhbXNlbGYyLmpzb24=';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            ...
            console.log(`Acces Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh Ilhamsqa`);
